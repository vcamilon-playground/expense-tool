...
/** Weekly grand-total income trend — mirrors LineTrendChart, labelled for income. */
export default function IncomeTrendChart({ data }: { data: TrendPoint[] }) {
    ...
    <div style={{ width: '100%', height: 200 }}>
      <ResponsiveContainer width="100%" height="100%">
        <LineChart data={data} margin={{ top: 4, right: 12, bottom: 0, left: 0 }}>
          ...
          />
          <Tooltip
            formatter={(value: number) => [formatMoney(value), 'Total income']}
