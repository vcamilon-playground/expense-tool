...
| `debts` | `id`, `user_id`, `name`, `kind` (credit_card/loan/personal/installment/other), `lender`, `principal` (original), `balance` (outstanding), `monthly_payment`, `interest_rate`, `due_day` (1-31), `active` |
